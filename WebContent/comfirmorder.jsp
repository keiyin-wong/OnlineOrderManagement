				...
				<form action="OrderController" method="post">
					<div class='col-xs-12'>
						<div class='table-responsive orders-list'>
								...
								<tbody>
									...
									if (cartlist.size() != 0) {
										for (Cart t : cartlist) {
											...
											out.println("<td>"+ t.getQuantity()+ "</td>");
											out.println("<td>" + t.getPriceEach() + "</td>");
											out.println("<td>" + t.itemTotal() + "</td>");
											out.println("</tr>");
									...
									out.println("<td><lable><input type=\"date\" name=\"requireddate\" placeholder=\"yyyy-mm-dd\"></label></td>");
									out.println("</tr>");
									out.println("<tr>");
									out.println("<td></td>");
									out.println("<td></td>");
									...
									out.println("<td><input type=\"number\" name=\"customernumber\" min=\"100\" max=\"999\"></td>");
									out.println("</tr>");
									%>
									<!-- <tr>
							...
							<input type="submit" name="RETURN" value="Back to Cart"/> 
							<input type="submit" name="ADD" value="Comfrim Orders"/>
						</div>
					</div>
				</form>
				</div>
