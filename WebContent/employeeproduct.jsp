				...
				<div class='row' id="tableContent">
								...
								<tbody>
									...
									if (products.size() != 0) {
										for (Product p : products) {
											out.println("<tr>");
											out.println("<td><a href=\"" + "EmployeeProductDetailsServlet?productCode=" + p.getProductcode() + "\"</a>"
											+ p.getProductcode() + "</td>");
											out.println("<td>" + p.getProductname() + "</td>");
											out.println("<td>" + p.getProductlineBean().getProductline() + "</td>");
											out.println("<td>" + p.getProductcode() + "</td>");
											out.println("<td>" + p.getProductvendor() + "</td>");
											out.println("<td>" + p.getProductdescription() + "</td>");
											out.println("<td>" + p.getQuantityinstock().toString() + "</td>");
											out.println("<td>" + p.getBuyprice().toString() + "</td>");
											out.println("<td>" + p.getMsrp().toString() + "</td>");
					...
					<nav aria-label="Navigation for staffs">
						<ul class="pagination">
							...
							out.println("<a class=\"page-link\" href=\"" + "EmployeeProductServlet?recordsPerPage=" + 10 + "&currentPage=1"
									+ "\">First</a>");
							out.println("</li>");
							%>
							...
							<li class="page-item">
								<%
								out.println("<a class=\"page-link\" href=\"" + "EmployeeProductServlet?recordsPerPage=" + 10 + "&currentPage="
									...
									$(this)
											...
											.bind(
													...
													function() {
														...
														var data = "delete=Delete&productCode="
																+ a;
														$
																.post(
																		"EmployeeProductDetailsServlet",
																		data)
																.done(
																		function(
																				data) {
