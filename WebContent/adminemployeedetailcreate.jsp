...
<body class='hbw-select2'>
						...
						<div class='row'>
							<div class='col-xs-6'>
								<div class="form-group row string optional">
									...
									<div class="col-sm-8">
										<input value=""
											class="string optional form-control" type="number" min="0" max="32,767"
											name="empNumber" required>
										<div id="empNumberFeedback"></div>
									</div>
								</div>
	...
	<script>
		$(document).ready(function(){
			  $("input[name='empNumber']").change(function(){
				var field =  $("input[name='empNumber']");
			    var value =  field.val();
			    var data = "empNumber=" + value;
			    $.post("AdminEmployeeNumberValidate", data).done(
						function(result) {
							 $("#empNumberFeedback").text(result);
							 if(result=="Employee exists"){
