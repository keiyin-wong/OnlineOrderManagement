...
<body>
					...
					<div class="col-md-8 col-sm-6 col-xs-4">
						<div class="main-menu">
							...
							<ul class="menu">
								...
								<li><a href="PaymentPaginationServlet?recordsPerPage=10 &currentPage=1"></a>Payment</li>
								<%
									if(admin!=null){
								%>
	...
	<div class="content-section">
		...
		%>
		<h2 class="container">Hello, <%=output %>!!!</h2>
		<%} %>
						...
						<div class='orders-filter-container' role='tabpanel'>
							<ul class='nav nav-tabs' role='tablist'>
								<li class='active' role='presentation'><a
									aria-controls='filter' href='#' role='tab'> Filter orders </a></li>
								<li role='presentation'><a aria-controls='search'
									href="EmployeeOrderServlet?shipped=SHIPPED&currentPage=1"
									role='tab'>Shipped</a></li>
								<li role='presentation'><a aria-controls='search'
									href="EmployeeOrderServlet?inProcess=INPROCESS&currentPage=1"
									role='tab'>In Process</a></li>
								<li role='presentation'><a aria-controls='search'
									href="EmployeeOrderServlet?onHold=ONHOLD&currentPage=1" role='tab'>On
										Hold</a></li>
							</ul>
									...
									<div class='row'>
										<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
											<form class="form-inline orders-filter"
												action="SearchServlet" accept-charset="UTF-8" method="get">
												<div class='col-xs-12 col-sm-7 col-md-6 col-lg-7'>
													<div class='row'>
														<div class="form-group col-sm-6 string optional">
															<label class="string optional col-sm-8 control-label">Order
																Number</label>
															<div class="col-sm-8">
				...
				<div class='row' id="tableContent">
							...
							<table class='table table-striped table-hover'>
								...
								<tbody>
									...
									if (orders.size() != 0) {
										for (Order t : orders) {
											out.println("<tr>");
											out.println("<td><a href=\"" + "EmployeeOrderDetailsServlet?orderNumber=" + t.getOrdernumber() + "\"</a>"
											+ t.getOrdernumber() + "</td>");
					...
					<nav aria-label="Navigation for staffs">
						<ul class="pagination">
							...
							out.println("<a class=\"page-link\" href=\"" + "EmployeeOrderServlet?recordsPerPage=" + 10 + "&currentPage=1"
									+ "\">First</a>");
							out.println("</li>");
							%>
							...
							<li class="page-item">
								<%
								out.println("<a class=\"page-link\" href=\"" + "EmployeeOrderServlet?recordsPerPage=" + 10 + "&currentPage="
							...
							if (currentPage < nOfPages) {
								...
								out.println("<li class=\"page-item\">");
								out.println("<a class=\"page-link\" href=\"" + "EmployeeOrderServlet?recordsPerPage=" + 10 + "&currentPage=" + nOfPages
								+ "\">Last</a>");
								out.println("</li>");
							}
							%>
