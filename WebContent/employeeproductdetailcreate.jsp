			...
			<div class='row'>
				<div class='col-xs-12'>
					...
					<form class="simple_form form-horizontal order-edit-form"  autocomplete="off"
						...
						<div class='row'>
							<div class='col-xs-6 form-outline'>
								<div class="form-group row string optional">
									...
									<div class="col-sm-8">
										...
										<div id="productCodeFeedback"></div>
									</div>
								</div>
								...
								<div class="form-group row string optional">
									...
									<div class="col-sm-8">
										<input value="" class="string optional form-control "
											type="text" name="productVendor" required>
									</div>
								</div>
								<div class="form-group row string optional">
									<label class="string optional col-sm-4 control-label">Product
								...
								<div class="form-group row string optional">
									...
									<div class="col-sm-8">
										<input class="string optional form-control" type="number"
											min="0" value="" name="quantityInStock" required>
									</div>
								</div>
								<div class="form-group row string optional">
									...
									<div class="col-sm-8">
										<input class="string optional form-control" type="number"
											step="0.01" min="0" value="" name="buyPrice" required>
									</div>
								</div>
								<div class="form-group row string optional">
									...
									<div class="col-sm-8">
										<input class="string optional form-control" type="number"
											step="0.01" min="0" max="999.99" value="" name="msrp" required>
							...
							<div class='row'>
								<div class='col-xs-12'>
									<input type="submit" class="btn btn-primary" name="create"
										style="color: #428bca; border: 1px solid #ddd; background-color: transparent" value="Create">
	...
	<script>
		$(document).ready(function(){
			  $("input[name='productCode']").change(function(){
				var field =  $("input[name='productCode']");
			    var value =  field.val();
			    var data = "productCode=" + value;
			    $.post("EmployeeProductCodeValidateServelt", data).done(
						function(result) {
							 $("#productCodeFeedback").text(result);
